...
| ----------------------------------------------------------------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | ------------------------------------------------------------- |
| [v1.17.0](https://gitlab.opencode.de/bmi/opendesk/deployment/opendesk/-/releases/v1.17.0) | --        | [Pre](#pre-upgrade-to-versions--v1170)                                                                                         | --                                       | ⬇ Install v1.15.x first                                     |
...
| [v1.1.x](https://gitlab.opencode.de/bmi/opendesk/deployment/opendesk/-/releases/v1.1.2)   | **yes**   | [Pre .0](./migrations-manual-archive.md#pre-upgrade-to-versions--v110) → [Pre .1](./migrations-manual-archive.md#pre-upgrade-to-versions--v111) → [Pre .2](./migrations-manual-archive.md#pre-upgrade-to-versions--v112) | [Post](./migrations-manual-archive.md#post-upgrade-to-versions--v110)  | [⚠ Install v1.0.0 first](./migrations-automated-archive.md#versions--v110-automated)          |
