...
# Migration requirements - Archive

> [!important]
> This document is the **archive** of openDesk's manual migration documentation. It covers the
> manual checks and actions for older openDesk releases.
>
> - For the manual checks and actions of the most recent openDesk releases, and for the overview
>   of the mandatory upgrade path, see [`migrations-manual.md`](./migrations-manual.md).
> - For the **automated** migrations, which openDesk runs on its own as part of every deployment,
>   see [`migrations-automated.md`](./migrations-automated.md).
...
<!-- TOC -->
* [Migration requirements - Archive](#migration-requirements---archive)
