...
#
# Usage:
#   nix build .#opencloud        # ghcr.io/tobias-weiss-ai-xr/umr/opendesk-edu/containers/opencloud:<version>
#   nix build .#default
#
#   docker load < result
#   docker tag opendesk-opencloud:<version> ghcr.io/tobias-weiss-ai-xr/umr/opendesk-edu/containers/opencloud:<version>
#   docker push ghcr.io/tobias-weiss-ai-xr/umr/opendesk-edu/containers/opencloud:<version>
#
