...
#
# Usage:
#   nix build .#sogo5            # ghcr.io/tobias-weiss-ai-xr/umr/opendesk-edu/containers/sogo5:<version>
#   nix build .#sogo6
#   nix build .#default          # = sogo6
#
#   # load + tag + push (or use scripts/push-*.sh):
#   docker load < result
#   docker tag opendesk-sogo6:<version> ghcr.io/tobias-weiss-ai-xr/umr/opendesk-edu/containers/sogo6:<version>
#   docker push ghcr.io/tobias-weiss-ai-xr/umr/opendesk-edu/containers/sogo6:<version>
#
