...
helm install my-release \
  --set rootUser.password=<YOUR_PASSWORD>,
...
The above command sets the MariaDB `root` account password to `<YOUR_PASSWORD>`. Additionally it creates a database named `my_database`.
