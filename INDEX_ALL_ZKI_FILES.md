...
### Security Policies (2 files) - `opendesk-edu/security-policies/zki/`

| # | File | Size | Lines | Description | License | Priority | Last Updated |
|---|------|------|-------|-------------|---------|----------|---------------|
| 12 | [SECURITY_POLICY.md](opendesk-edu/security-policies/zki/SECURITY_POLICY.md) | 36 KB | ~950 | Main IT Security Policy (14 chapters) | AGPL-3.0 | **Critical** | 2026-07-14 |
| 13 | [INCIDENT_RESPONSE_PLAN.md](opendesk-edu/security-policies/zki/INCIDENT_RESPONSE_PLAN.md) | 39 KB | ~1,100 | Incident Response Plan (BSI Standard 200-3 aligned) | AGPL-3.0 | **Critical** | 2026-07-14 |
...
### Helm Charts (2 files) - `opendesk-edu/helmfile/charts/security/`

| # | File | Size | Lines | Description | License | Priority | Last Updated |
|---|------|------|-------|-------------|---------|----------|---------------|
| 14 | [Chart.yaml](opendesk-edu/helmfile/charts/security/Chart.yaml) | 2 KB | ~65 | Security Helm chart metadata | Apache-2.0 | High | 2026-07-16 |
| 15 | [zki-compliance-policies.yaml](opendesk-edu/helmfile/charts/security/kyverno-policies/zki-compliance-policies.yaml) | 39 KB | ~1,200 | 20+ Kyverno ClusterPolicies | Apache-2.0 | **Critical** | 2026-07-16 |
...
### Application Configuration (2 files) - `opendesk-edu/helmfile/apps/edu/security/`

| # | File | Size | Lines | Description | License | Priority | Last Updated |
|---|------|------|-------|-------------|---------|----------|---------------|
| 16 | [helmfile.yaml.gotmpl](opendesk-edu/helmfile/apps/edu/security/helmfile.yaml.gotmpl) | 1.5 KB | ~50 | Deployment configuration | Apache-2.0 | High | 2026-07-16 |
| 17 | [values.yaml.gotmpl](opendesk-edu/helmfile/apps/edu/security/values.yaml.gotmpl) | 18 KB | ~600 | Security configuration values (13 sections) | Apache-2.0 | High | 2026-07-16 |
...
| 2 | [SECURITY_POLICY.md](opendesk-edu/security-policies/zki/SECURITY_POLICY.md) | 30+ min | Your main policy document |
| 3 | [INCIDENT_RESPONSE_PLAN.md](opendesk-edu/security-policies/zki/INCIDENT_RESPONSE_PLAN.md) | 25+ min | Your incident response procedures |
...
| 6 | [zki-compliance-policies.yaml](opendesk-edu/helmfile/charts/security/kyverno-policies/zki-compliance-policies.yaml) | 30 min | Review the policies you'll enforce |
...
| 2 | [zki-compliance-policies.yaml](opendesk-edu/helmfile/charts/security/kyverno-policies/zki-compliance-policies.yaml) | 30 min | Understand the policies you're deploying |
| 3 | [ZKI_CRITICAL_ACTIONS.md](ZKI_CRITICAL_ACTIONS.md) | 20 min | Your action items (webhook auth, backup) |
| 4 | [Chart.yaml](opendesk-edu/helmfile/charts/security/Chart.yaml) | 5 min | Chart metadata |
| 5 | [helmfile.yaml.gotmpl](opendesk-edu/helmfile/apps/edu/security/helmfile.yaml.gotmpl) | 5 min | Deployment configuration |
| 6 | [values.yaml.gotmpl](opendesk-edu/helmfile/apps/edu/security/values.yaml.gotmpl) | 20 min | Security configuration values |
...
| 2 | [zki-compliance-policies.yaml](opendesk-edu/helmfile/charts/security/kyverno-policies/zki-compliance-policies.yaml) | 30 min | See what policies affect your code |
| 3 | [SECURITY_POLICY.md](opendesk-edu/security-policies/zki/SECURITY_POLICY.md) | 30 min | Chapter 8: Application Security |
...
| 4 | [SECURITY_POLICY.md](opendesk-edu/security-policies/zki/SECURITY_POLICY.md) | 30 min | Review security policies |
...
3. [zki-compliance-policies.yaml](opendesk-edu/helmfile/charts/security/kyverno-policies/zki-compliance-policies.yaml) - Policies to deploy
4. [helmfile.yaml.gotmpl](opendesk-edu/helmfile/apps/edu/security/helmfile.yaml.gotmpl) - Deployment configuration
5. [values.yaml.gotmpl](opendesk-edu/helmfile/apps/edu/security/values.yaml.gotmpl) - Configuration values
...
**Read in this order**:
1. [SECURITY_POLICY.md](opendesk-edu/security-policies/zki/SECURITY_POLICY.md) - Main policy
2. [INCIDENT_RESPONSE_PLAN.md](opendesk-edu/security-policies/zki/INCIDENT_RESPONSE_PLAN.md) - Incident response
3. [zki-compliance-policies.yaml](opendesk-edu/helmfile/charts/security/kyverno-policies/zki-compliance-policies.yaml) - Kyverno policies
...
3. [SECURITY_POLICY.md](opendesk-edu/security-policies/zki/SECURITY_POLICY.md)
4. [INCIDENT_RESPONSE_PLAN.md](opendesk-edu/security-policies/zki/INCIDENT_RESPONSE_PLAN.md)
5. [zki-compliance-policies.yaml](opendesk-edu/helmfile/charts/security/kyverno-policies/zki-compliance-policies.yaml)
...
**AGPL-3.0 Files**:
- [SECURITY_POLICY.md](opendesk-edu/security-policies/zki/SECURITY_POLICY.md)
- [INCIDENT_RESPONSE_PLAN.md](opendesk-edu/security-policies/zki/INCIDENT_RESPONSE_PLAN.md)
