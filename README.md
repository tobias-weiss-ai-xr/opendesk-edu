...
| Collaborative notes  | Notes (aka Docs)            | MIT                                                                                    | [4.1.0](https://github.com/suitenumerique/docs/releases/tag/v4.1.0)                           | Online documentation/welcome document available in installed application                                                              |
...
| Project management   | OpenProject                 | GPL-3.0-only                                                                           | [16.6.4](https://www.openproject.org/docs/release-notes/16-6-4/)                              | [For the most recent release](https://www.openproject.org/docs/user-guide/)                                                           |
