...
| Portal & IAM         | Nubus                       | AGPL-3.0-or-later                                                                      | [1.19.0](https://docs.software-univention.de/nubus-kubernetes-release-notes/1.x/en/1.19.html) | [Univention's documentation website](https://docs.software-univention.de/n/en/nubus.html)                                             |
| Project management   | OpenProject                 | GPL-3.0-only                                                                           | [17.2.3](https://www.openproject.org/docs/release-notes/17-2-3/)                              | [For the most recent release](https://www.openproject.org/docs/user-guide/)                                                           |
