...
| Groupware            | OX App Suite                | GPL-2.0-only (backend), AGPL-3.0-or-later (frontend)                                   | [8.45](https://documentation.open-xchange.com/appsuite/releases/8.45/)                        | Online documentation available from within the installed application; [Additional resources](https://documentation.open-xchange.com/) |
| Knowledge management | XWiki                       | LGPL-2.1-or-later                                                                      | [17.4.8](https://www.xwiki.org/xwiki/bin/view/ReleaseNotes/Data/XWiki/17.4.8/)                | [For the most recent release](https://www.xwiki.org/xwiki/bin/view/Documentation)                                                     |
| Portal & IAM         | Nubus                       | AGPL-3.0-or-later                                                                      | [1.17.0](https://docs.software-univention.de/nubus-kubernetes-release-notes/1.x/en/1.17.html) | [Univention's documentation website](https://docs.software-univention.de/n/en/nubus.html)                                             |
| Project management   | OpenProject                 | GPL-3.0-only                                                                           | [17.1.2](https://www.openproject.org/docs/release-notes/17-1-2/)                              | [For the most recent release](https://www.openproject.org/docs/user-guide/)                                                           |
