...
|            | jitsiKeycloakAdapter     |        :x:         |         :white_check_mark:         |                           :white_check_mark:                           |        :white_check_mark:         |               :x:               |  :white_check_mark:   |   1993    |    1993    |    -    |
...
| Postfix    | postfix                  |        :x:         |         :white_check_mark:         | :x: (`DAC_OVERRIDE`, `FOWNER`, `SETUID`, `SETGID`, `NET_BIND_SERVICE`) |        :white_check_mark:         |               :x:               |          :x:          |     -     |     -      |   101   |
